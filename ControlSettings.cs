...
namespace ConsoleApp1
{
	public class ControlSettings
	{
		...
		private int particleMin = 100, particleMax = 100000;
		...
		{
			myParticle.Contraste = opacityMin +
			(float)(UV.OpacityBar.Value * (opacityMax - opacityMin)) / UV.OpacityBar.Maximum;
			UV.OpacityBox.Text = myParticle.Contraste.ToString();
		}
		...
		public void InitSlidesGui()
		{
			...
			UV.OpacityBar.Value = (int)(((myParticle.Contraste - opacityMin) * UV.OpacityBar.Maximum) / (opacityMax - opacityMin));
